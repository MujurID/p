...
const targettoken = ''; //sc token target yg mao dibeli
...
try {
  ...
  //const minliqpc = (100*(10**18));
  //console.log(`minliqpc = ${minliqpc/(10**18)} BNB`);
  if(tokenOut == targettoken){ //targettoken isi targettoken kalian
  //if(pairBNBvalue > minliqpc){ //minimal liquidity 100 BNB https://eth-converter.com
